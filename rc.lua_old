...
beautiful.init("/home/zach/.config/awesome/themes/soft/theme.lua")

-- This is used later as the default terminal and editor to run.
terminal = "termite"
editor = "vim"
editor_cmd = terminal .. " -e '" .. editor ..  " ~/.config/awesome/rc.lua'"

-- Default modkey.
-- Usually, Mod4 is the key with a logo between Control and Alt.
-- If you do not like this or do not have such a key,
-- I suggest you to remap Mod4 to another key using xmodmap or other tools.
-- However, you can use another modifier like Mod1, but it may cause conflicts.
modkey = "Mod4"
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "base", "chat", "term", "code", "gimp" }, s, layouts[1])
end
-- }}}
...
awful.layout.set(awful.layout.suit.floating, tags[1][5]) -- gimp should float as well
